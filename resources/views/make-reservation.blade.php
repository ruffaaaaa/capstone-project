        ...
        <div id="reservationDetailsForm" class="hidden mx-full flex flex-col items-center justify-center">
            ...
            <div class = "w-100">
                ...
                <div class="mt-5">
                    ...
                    <div class="flex pt-5">
                        <input type="file" id="attachments" name="attachments[]" accept="image/png" multiple class="hidden" onchange="displayFiles()">
                        <label for="attachments" accept="image/png" class="inline-block bg-green-100 text-green-700 rounded-full w-10 h-10 text-center cursor-pointer m-2">
