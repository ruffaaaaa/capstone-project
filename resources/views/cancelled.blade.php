...
<body class="bg-[#076334]">
    <div class="flex min-h-screen items-center justify-center">
      <div class="rounded bg-white p-8 text-center justify-center shadow-md">
        ...
        <p class="text-xs font-bold uppercase text-[#087830]">RESERVATION CANCELLED</p>
        <p class="text-lg font-bold my-6">Your reservation has been successfully cancelled. </p>
        <p class="text-xs  my-6">If this was done in error, please contact our team immediately. </p>
        <div class="mt-9">
