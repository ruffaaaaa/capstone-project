            ...
            <div class="flex-grow">
                ...
                <div class="p-4">
                    <ul class="space-y-1">
                        ...
                        <li>
                            <a href="{{ route('admin.reservation', ['role_id' => $user->role_id]) }}" title="Reservation Management" class="flex  hover:bg-green-300  rounded-xl font-bold text-sm text-gray-900 py-2 px-4">
                                <span class="icon">
                        ...
                        <li>
                            <a href="{{ route('admin.facilities', ['role_id' => $user->role_id]) }}" title="Facilities Management" class="flex  hover:bg-green-300  rounded-xl font-bold text-sm text-gray-900 py-2 px-4">
                                <span class="icon">
                    ...
                    <div class="flex overflow-hidden flex-wrap gap-10 justify-center items-center max-w-full px-8 pt-3">
                        <div class="overflow-hidden grow shrink self-stretch pb-20 pl-3 my-auto text-6xl font-bold text-black min-h-[164px] min-w-[240px] w-[588px] max-md:pr-5 max-md:max-w-full max-md:text-4xl">
                            <div class="text-sm font-medium text-gray-700">
                                You're logged in as <span class="font-bold text-green-700">{{ $user->role->name }}</span>.
                            </div>
