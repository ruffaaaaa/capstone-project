            ...
            <div class="flex flex-col justify-between h-full">
                <div class="flex-grow">
                    ...
                    <div class="p-4">
                        <ul class="space-y-1">
                            <li>
                            <a href="/admin-dashboard" title="Dashboard" class="flex items-center hover:bg-green-300 rounded-xl font-bold text-sm text-black py-2 px-4">
                            ...
                            <li>
                                <a href="admin-reservation" title="Reservation" class="flex  hover:bg-green-300  rounded-xl font-bold text-sm text-gray-900 py-2 px-4">
                                    <span class="icon">
                            ...
                            <li>
                                <a href="admin-facilities" title="Facilities" class="flex items-center bg-[#087830] rounded-xl font-bold text-sm text-white py-2 px-4">
                                    <span class="icon">
                            ...
                            <li>
                            <div class="relative">
                                <button onclick="toggleSettings()" title="Settings" class="flex hover:bg-green-300 rounded-xl font-bold text-sm text-gray-900 py-2 px-4 w-100 focus:outline-none">
                                    <span class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                                    ...
                                    <span class="text hidden">Settings</span>
                                </button>
                                <div id="settingsDropdown" class="absolute hidden bg-white shadow-lg py-2 mt-2 w-100 rounded-xl">
                                    ...
                                    <a href="admin-profile" title="Profile" class=" hover:bg-green-300 flex font-bold text-sm text-gray-900 py-2 px-4">
                                        ...
                                        <span class="text hidden">Profile</span>
                                    </a> 
                                </div>
                            </div>
                        </li>
