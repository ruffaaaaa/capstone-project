                ...
                <div class="flex-grow">
                    ...
                    <div class="p-4">
                        <ul class="space-y-1">
                            ...
                            <li>
                                <a href="admin-facilities" title="Facilities" class="flex items-center hover:bg-green-300 rounded-xl font-bold text-sm text-black py-2 px-4">
                                    <span class="icon">
                            ...
                            <div class="relative">
                                ...
                                <div id="settingsDropdown" class="absolute hidden bg-white shadow-lg py-2 mt-2 w-100 rounded-xl">
                                    ...
                                    <a href="admin-profile" title="Profile" class=" bg-[#087830] flex font-bold text-sm text-white py-2 px-4">
                                        <span class="icon">
